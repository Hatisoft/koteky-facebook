...
module.exports = class providerFacebook extends provider{
    ...
    login(window)
    {
        return new Promise((resolve,reject) => {
            var scope = 'user_posts,user_friends';
            var params = {};
    ...
    subscribe()
    {
        this.fb.api('me/friends', {}, (res) => {
            ...
            //this._getPosts();
            this._subscriptionId = setInterval(this._getPosts.bind(this), 5*60000);
        });
    ...
    _getPosts()
    {
        ...
        for (let friend of this._friends) {
            /*jshint -W083 */
            var parameters = {};
            if(this._lastRetrieve)
                parameters.since = this._lastRetrieve.value;
